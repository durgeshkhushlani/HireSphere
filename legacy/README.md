# HireSphere v1 (Legacy — MERN prototype)

> **Status: Archived.** This is the original MERN-stack prototype, kept here for reference only.
> Active development has moved to the v2 rebuild — see the [root README](../README.md) for the current architecture and progress.
...
```bash
git clone https://github.com/durgeshkhushlani/hiresphere.git
```
